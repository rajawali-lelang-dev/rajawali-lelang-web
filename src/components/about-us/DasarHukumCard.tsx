...
export default function DasarHukumCard({ title, description, items, icon }: DasarHukumCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-2xl p-6 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 border border-secondary-200">
      <div className="flex items-start gap-4 mb-4">
        <div className="w-14 h-14 bg-secondary-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md">
          <IconComponent className="w-7 h-7 text-white" />
        </div>
        <div>
          <h3 className="font-manrope font-bold text-xl text-secondary-700 mb-2">
            {title}
          </h3>
        </div>
      </div>
