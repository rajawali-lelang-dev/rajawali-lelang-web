          ...
          <div className="lg:col-span-1">
            ...
            <div className="mb-6">
              ...
              >
                ...
                <span className="font-manrope text-sm font-medium">+62 812-3456-7890</span>
              </a>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <a 
                  href="https://linkedin.com/company/RajawaliLelangIndo" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary-500 hover:text-primary-600 transition-colors group"
                  title="LinkedIn - RajawaliLelangIndo"
                >
                  <div className="w-9 h-9 bg-primary-100 rounded-full flex items-center justify-center group-hover:bg-primary-200 transition-colors">
                    <svg className="w-4 h-4 text-primary-600" fill="currentColor" viewBox="0 0 24 24">
