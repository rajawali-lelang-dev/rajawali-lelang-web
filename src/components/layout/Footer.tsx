...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700 text-white mt-auto">
      <div className="max-w-screen-2xl mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="font-manrope text-sm text-neutral-300 leading-relaxed">
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.href}>
                  <Link 
                    href={link.href} 
                    className="font-manrope text-sm text-neutral-300 hover:text-white transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-neutral-700">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link href="/terms" className="font-manrope text-sm text-neutral-400 hover:text-white transition-colors">
                Syarat & Ketentuan
              </Link>
              <Link href="/privacy" className="font-manrope text-sm text-neutral-400 hover:text-white transition-colors">
                Kebijakan Privasi
              </Link>
            </div>
          </div>
