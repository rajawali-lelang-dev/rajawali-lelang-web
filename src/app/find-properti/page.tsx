...
export default function FindPropertiPage() {
  return (
    <div className="relative min-h-screen bg-background overflow-hidden">
          ...
          <FadeInUp delay={0}>
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="https://wa.me/628170005646?text=Halo, saya ingin berkonsultasi tentang properti lelang" target="_blank" rel="noopener noreferrer">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-16 md:py-20 max-w-7xl">
        <FadeInUp delay={0}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <FadeInScale delay={400}>
            <div className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all text-center">
              ...
              <p className="font-manrope text-neutral-600 text-sm leading-relaxed">
                Data harga properti yang akurat dan menarik
              </p>
            </div>
          </FadeInScale>
        </div>
