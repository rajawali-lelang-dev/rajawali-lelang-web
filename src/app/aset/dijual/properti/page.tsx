...
export const metadata: Metadata = {
  ...
  description:
    "Temukan properti terbaik untuk dijual - Rumah, Apartemen, Ruko, Villa, Tanah, dan Gudang dengan harga terjangkau.",
};
...
export default function PropertiDijualPage() {
  return (
    <AsetLayout
      ...
      description="Temukan properti terbaik untuk dijual dengan proses yang mudah, aman, dan menguntungkan"
