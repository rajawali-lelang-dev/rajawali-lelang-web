...
export default function AsetDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
            ...
            {isLelang(item) ? (
              <>
                ...
                <div className="flex items-center gap-4 mt-4">
                  <div>
                    <p className="text-primary-600 text-sm">Tanggal Lelang</p>
                    <p className="text-2xl font-semibold">{item.tanggalLelang || '-'}</p>
                  </div>
                  {'jamLelang' in item && (
                    <div>
                      <p className="text-primary-600 text-sm">Jam Lelang</p>
                      <p className="text-2xl font-semibold">{item.jamLelang || '-'}</p>
                    </div>
                  )}
                </div>
              </>
      ...
      {/* Main Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-7xl -mt-20 relative z-10">
        <div className="grid lg:grid-cols-3 gap-4 lg:gap-6 xl:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 lg:space-y-6">
            ...
            <div className="bg-gradient-to-r from-slate-700 to-slate-900 rounded-2xl p-8 text-center">
              ...
              <Link href={`https://wa.me/628170005646?text=Saya tertarik dengan ${item.title}`} target="_blank" rel="noopener noreferrer">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                <div className="flex justify-between items-center py-3 border-b border-slate-200">
                  <span className="text-slate-600 text-sm">Nilai Limit</span>
              ...
              <div className="mt-6 pt-6 border-t border-slate-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm">
                    ...
                    <span className="text-slate-600">08170005646</span>
                  </div>
                  <div className="flex items-center gap-3 text-sm">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#64748b" strokeWidth="2">
